...
void setup()
{
  ...
  // cube 3
  opc.led(8, -4 + width * 1/6, -0 + height * 3/6);
  opc.led(9, -5 + width * 1/6, -1 + height * 3/6);
  opc.led(10, -6 + width * 1/6, -2 + height * 3/6);
  opc.led(11, -7 + width * 1/6, -3 + height * 3/6);
   
  // cube 4
  opc.led(12, -4 + width * 2/6, -0 + height * 2/6);
  opc.led(13, -5 + width * 2/6, -1 + height * 2/6);
  opc.led(14, -6 + width * 2/6, -2 + height * 2/6);
  opc.led(15, -7 + width * 2/6, -3 + height * 2/6);
   
  // cube 5
  opc.led(16, -0 + width * 3/6, -4 + height * 1/6);
  opc.led(17, -1 + width * 3/6, -5 + height * 1/6);
  opc.led(18, -2 + width * 3/6, -6 + height * 1/6);
  opc.led(19, -3 + width * 3/6, -7 + height * 1/6);
  
  // cube 6
  opc.led(20, -0 + width * 2/6, -4 + height * 2/6);
  opc.led(21, -1 + width * 2/6, -5 + height * 2/6);
  opc.led(22, -2 + width * 2/6, -6 + height * 2/6);
  opc.led(23, -3 + width * 2/6, -7 + height * 2/6);
  ...
  // cube 10
  opc.led(36, -0 + width * 4/6, -4 + height * 2/6);
  opc.led(37, -1 + width * 4/6, -5 + height * 2/6);
  opc.led(38, -2 + width * 4/6, -6 + height * 2/6);
  opc.led(39, -3 + width * 4/6, -7 + height * 2/6);
  ...
  // cube 15
  opc.led(56, -4 + width * 5/6, -0 + height * 5/6);
  opc.led(57, -5 + width * 5/6, -1 + height * 5/6);
  opc.led(58, -6 + width * 5/6, -2 + height * 5/6);
  opc.led(59, -7 + width * 5/6, -3 + height * 5/6);
